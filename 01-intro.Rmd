...
```{r model, fig.cap='Biodanza-Model (links: getekend door Rolando Toro in 2008, rechts: versie aangepast van op de AIPOB website)', out.width='100%', fig.asp=.8, fig.align='center', echo=FALSE}
...
Tijdens een Biodanza-sessie laten we (een deel van) de vijf lijnen pulseren door een serie van oefeningen waarvan de eerste onze identiteit versterken en de daaropvolgende oefeningen progressief biologische regressie stimuleren. Oefeningen die de identiteit versterken zorgen ervoor dat deelnemers zich bewuster worden van zichzelf, de wereld om hen heen en hoe zij in die wereld staan. Oefeningen die biologische regressie stimuleren, stimuleren daarentegen het oplossen van ons ego en om ons te verbinden met de verschillende niveaus van ons onbewuste. 
