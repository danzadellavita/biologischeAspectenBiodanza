...
De engelstalige versie van het eboek kan je vinden op: \href{https://biodanzabrugge.be/biologicalAspectsBiodanza/}{BiologicalAspectsBiodanza}
...
\caption{Biodanza-Model (links: getekend door Rolando Toro in 2008, rechts: versie aangepast van op de AIPOB website)}\label{fig:model}
\end{figure}
